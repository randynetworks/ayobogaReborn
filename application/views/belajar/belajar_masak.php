<div class="main-page container sm-5 mt-3 mb-3">
	<div class="text-center">
		<h1 class="judul">Sudah siap belajar masak?</h1>
		<br>
	</div>
	<h6 class="ban text-white pt-3 pb-3 text-center">Tenang aja, semua belajar dari awal kok, engga ada yang namanya telat!</h6>
